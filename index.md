...
# 变更记录
> 2023/08/07 发布windows平台的asynframe framework v1.5.0  
1. 发布版本: 面向设计重构架构/接口  
2. 修复已知问题  
...
# 编译环境
> sdk_v1.5.0-Msvc2019_20230807.zip是通过Microsoft Visual Studio 2019编译的SDK  
> sdk_v1.5.0-Msvc2013_20230807.zip是通过Microsoft Visual Studio 2013编译的SDK  
